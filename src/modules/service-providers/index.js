...
router.get('/:serviceProviderId', authentication.verifyTokenIfExists, validator.getServiceProviderById, controller.getServiceProviderById)
...
router.patch('/:serviceProviderId', authentication.verifyToken, validator.updateServiceProviderById, controller.updateServiceProviderById)

//router.patch('/:serviceProviderId/updateBusinessSubTypes', authentication.verifyToken, validator.updateBusinessSubTypes, controller.updateBusinessSubTypes)
